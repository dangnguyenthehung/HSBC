...
jQuery(document).ready(function ($) {
    ...
    $(".navbar-collapse .navbar-nav").children().eq(activeIndex).addClass("active");

    $(".navbar-collapse .navbar-nav li").on("click",
        function () {
            $(".navbar-collapse .navbar-nav li.active").removeClass("active");
            $(this).addClass("active");
            activeIndex = $(".navbar-collapse .navbar-nav > li").index(this);
            localStorage.setItem("activeIndex", activeIndex);
        });
});